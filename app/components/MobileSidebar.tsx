...
export default function MobileSidebar({ sessions, currentSessionId, isDarkMode }: MobileSidebarProps) {
  const [isOpen, setIsOpen] = useState(false);

  const cx = {
    panel: isDarkMode ? "bg-[#0a100d]" : "bg-[#FDFCF8]",
  ...
  return (
    <>
      ...
      {isOpen && (
        <div 
          className={`fixed inset-0 z-40 ${cx.overlay} md:hidden`}
